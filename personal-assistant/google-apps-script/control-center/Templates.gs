...
var CONTROL_CENTER_REGISTRY_CACHE_ = null;
var CONTROL_CENTER_REGISTRY_ID_CACHE_ = '';
...
function getRegistrySpreadsheet_() {
  ...
  if (CONTROL_CENTER_REGISTRY_CACHE_ && CONTROL_CENTER_REGISTRY_ID_CACHE_ === id) {
    return CONTROL_CENTER_REGISTRY_CACHE_;
  }

  CONTROL_CENTER_REGISTRY_ID_CACHE_ = id;
  CONTROL_CENTER_REGISTRY_CACHE_ = SpreadsheetApp.getActive();
  return CONTROL_CENTER_REGISTRY_CACHE_;
}
