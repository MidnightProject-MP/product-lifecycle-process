...
- Communicate release start, completion, rollback, and postmortem needs when relevant.
...
| Postmortem needed | Unexpected | Why postmortem is needed, owner, timeline, scope, and expected outputs. |
